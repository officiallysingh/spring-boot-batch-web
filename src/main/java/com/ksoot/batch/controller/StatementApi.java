...
public interface StatementApi extends Api {
  ...
  ResponseEntity<APIResponse<?>> submitStatementJob(
      ...
      @Parameter(
          ...
          @RequestParam(value = "cardNumbers", required = false)
...
//  @Operation(
//      operationId = "get-interest-accrued",
//      summary =
//          "Gets the aggregate interest accrued for given Loan account number in given date range",
//      tags = {"Accrual"})
//  @ApiResponses(
//      value = {
//        @ApiResponse(responseCode = "200", description = "Accrued interest returned successfully"),
//        @ApiResponse(
//            responseCode = "400",
//            description = "Bad request",
//            content = @Content(examples = @ExampleObject(BAD_REQUEST_EXAMPLE_RESPONSE))),
//        @ApiResponse(
//            responseCode = "404",
//            description = "Interest accrual not found for given parameters",
...
//            content = @Content(examples = @ExampleObject(INTERNAL_SERVER_ERROR_EXAMPLE_RESPONSE)))
//      })
//  @GetMapping("/loan/{loanAccountNumber}/interestAccrued")
//  ResponseEntity<AggregateInterestAccrued> getStatements(
//      @Parameter(description = "Loan Account number", required = true, example = "LAN001")
//          @PathVariable
//          final String loanAccountNumber,
//      @Parameter(
//              description = "From date in ISO format yyyy-MM-dd. Inclusive",
//              example = "2023-08-10",
//              required = true)
//          @RequestParam
//          final LocalDate dateFromInterestAccrued,
//      @Parameter(
//              description = "Till date in ISO format yyyy-MM-dd. Inclusive",
//              example = "2023-08-15",
//              required = true)
//          @RequestParam
